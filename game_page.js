...
function send(){
    ...
    charAt_middle=word.charAt(length_divide_2);
    console.log(charAt_middle);
    length_minus_1=word.length-1;
    charAt_last=word.charAt(length_minus_1);
    console.log(charAt_last);
    remove_charAt1=word.replace(charAt1,"_");
    remove_charAt2=remove_charAt1.replace(charAt_middle,"_");
    remove_charAt3=remove_charAt2.replace(charAt_last,"_");
